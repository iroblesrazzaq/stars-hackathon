...
def load_classification_data(datadir=DATADIR, fraction=1.0):
    ...
    double_compact_objects = pd.read_pickle(datadir)
    for key in ignore:
                                                    ...
                                                    'eval_metric': 'logloss',
                                                            'use_label_encoder': False,
                                                                    'tree_method': 'hist',  # Use 'hist' instead of 'gpu_hist'
                                                                            'predictor': 'cpu',  # Use 'cpu' instead of 'gpu_predictor'
                                                                                    'n_estimators': 500,
...
if __name__ == "__main__":
    fraction = 1.0 # Specify the fraction of the dataset to use (e.g., 0.1 for 10%)
