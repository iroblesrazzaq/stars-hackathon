...
#SBATCH --job-name=stellar_classification   # Job name
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --ntasks=1                          # Number of tasks (processes)
#SBATCH --cpus-per-task=4                   # Number of CPUs per task
#SBATCH --gres=gpu:1                        # Request GPU resource
#SBATCH --mem=16G                           # Memory total in MB
#SBATCH --time=02:00:00                     # Time limit hrs:min:sec
#SBATCH --output=stellar_classification_%j.log # Standard output and error log

module load python/3.8                      # Load Python module, adjust as necessary
module load cuda/11.2                       # Load CUDA module, adjust version as necessary
module load cudnn/8.1.0                     # Load CUDNN module, adjust version as necessary

source activate myenv                       # Activate conda environment, adjust as necessary
